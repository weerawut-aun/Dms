                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-tools">
                                <a type="button" class="btn btn-danger float-right" style="margin-right: 16px;" href="../details_project.php?pro_id=<?= $_SESSION['pro_id'] ?>">ยกเลิก</a>
                            </div>
                        ...
                        ORDER BY c.clt_id asc";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a type="button" class="btn btn-info" href="clt_file.php?clt_id=<?= $clt_id ?>">ดาวน์โหลด</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
