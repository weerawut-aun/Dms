                        ...
                        <div class="card-body">
                            ...
                            <table id="tb_other" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $query_oth = "SELECT o.*,usr_firstname,usr_lastname FROM other  as o 
                        ...
                        ORDER BY o.oth_id asc";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $oth['usr_firstname'] . " " . $oth['usr_lastname']; ?></td>
                                            <td><a type="button" class="btn btn-info" href="other_file.php?oth_id=<?= $oth_id ?>">ดาวน์โหลด</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
