...
$query_mss = "SELECT * FROM meet_sign_summary WHERE y_id='" . $_SESSION['y_id'] . "'";
$result_mss = mysqli_query($con, $query_mss) or die(mysqli_errno($query_mss));
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">ใบลงทะเบียนผู้เข้าร่วมประชุมสรุปผล</h2>
                        </div>
                        <div class="card-body">

                            <div class="col-md-12">
                                <form id="uploadFormmss" method="POST" action="uploaded_mss.php">
                                    <div class="form-group">
                                        <input type="file" name="mss_filename" id="mss_filename" class="form-control-file">
                                        <br>
