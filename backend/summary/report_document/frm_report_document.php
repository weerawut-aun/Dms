...
chk_management();
$query_rpd = "SELECT rpd_id,y_id FROM report_document WHERE y_id='" . $_SESSION['y_id'] . "'";
$result_rpd = mysqli_query($con, $query_rpd) or die(mysqli_errno($query_rpd));
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">รายงานการประชุมสรุปผล</h2>
                        </div>
                        <div class="card-body">

                            <div class="col-md-12">
                                <form id="uploadFormrpd" method="POST" action="uploaded_rpd.php">
                                    <div class="form-group">
                                        <input type="file" name="rpd_filename" id="rpd_filename" class="form-control-file">
                                        <br>
