...
$query_rms = "SELECT * FROM report_meet_summary WHERE y_id='" . $_SESSION['y_id'] . "'";
$result_rms = mysqli_query($con, $query_rms) or die(mysqli_errno($query_rms));
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">รายงานประชุม</h2>
                        </div>
                        <div class="card-body">

                            <div class="col-md-12">
                                <form id="uploadFormrms" method="POST" action="uploaded_rms.php">
                                    <div class="form-group">
                                        <input type="file" name="rms_filename" id="rms_filename" class="form-control-file">
                                        <br>
