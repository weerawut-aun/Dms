                ...
                <div class="container-fluid">
                    <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        if ($num_rows > 0) {
                                            ...
                                            while ($row = mysqli_fetch_array($result_image)) {
                                                ...
                                                $url = '../../../data/'.$path.'/project/'.$pro_id.'/image/';
                        ...
                        <div class="card-footer clearfix">
                            <a type="button" class="btn btn-danger pull-right" style="margin-right: 16px;" href="<?php echo BASE_URL ?>/project/<?= $_SESSION['pro_id'] ?>">ย้อนกลับ</a>
                        </div>
                    </div>
