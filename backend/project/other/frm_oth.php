...
$query_oth = "SELECT pro_id,oth_id FROM project_details WHERE pro_id='" . $_SESSION['pro_id'] . "'";

$result_oth = mysqli_query($con, $query_oth);
$rows_oth = mysqli_fetch_assoc($result_oth);
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <h2 class="card-title">อื่นๆ</h2>
                        </div>
                        <div class="card-body">

                            <div class="col-sm-12">

                                <form name="uploadFormoth" id="uploadFormoth" method="POST" action="../other/uploaded_oth.php">
                                    <div class="form-group">
                                        <input type="file" name="oth_filename" id="oth_filename" class="form-control-file">
                                        <br>
                                        <input type="hidden"  name="MAX_FILE_SIZE" value="<?php echo $size;  ?>">
                                        <?php if ($rows_oth['oth_id'] != 0) { ?>
